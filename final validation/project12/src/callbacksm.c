...
void
on_button1m_clicked                     (GtkWidget       *data,
                                        gpointer         user_data)
{
GtkWidget *window;
GtkWidget *dialog;
...
else if (verifierm(Username, Password)==2)
{		
	login=lookup_widget(data,"login");
...
void
on_calendar1m_day_selected_double_click (GtkWidget     *calendar,
                                        gpointer         user_data)
{
  GtkWidget *bienvenue;
  GtkWidget *window2;
...
void
on_button3m_clicked                     (GtkWidget       *objet_graphique,
                                        gpointer         user_data)
{
GtkWidget *jour;
GtkWidget *mois;
...
*/
void
gtk_back_bienvenuem                     (GtkWidget       *back,
                                        gpointer         user_data)
{
GtkWidget *window2;
GtkWidget *bienvenue;
...
void
on_button6m_clicked                     (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *window2;
GtkWidget *treeview1;
...
void on_combobox3m_changed                   (GtkWidget     *combobox,
                                        gpointer         user_data)
{
GtkWidget *combobox3;
GtkWidget *combobox5;
...
void on_button8m_clicked                     (GtkWidget       *button,
                                        gpointer         user_data)
{
  GtkWidget *notebook1;
  GtkWidget *bienvenue;
...
/*ajouter*/
void on_button7m_clicked                     (GtkWidget       *button,
                                        gpointer         user_data)
{
  GtkWidget *bienvenue;
  GtkWidget *window2;
...
void on_button9m_clicked                     (GtkWidget       *button,
                                        gpointer         user_data)
{
  GtkWidget *combobox5;
  GtkWidget *combobox8;
...
void
on_ajoutadm_clicked                     (GtkWidget       *button,
                                        gpointer         user_data)
{
  GtkWidget *admin1;
  GtkWidget *window3;
...
void
on_button17m_clicked                    (GtkWidget       *button,
                                        gpointer         user_data)
{
GtkWidget *window2;
GtkWidget *treeview1;
