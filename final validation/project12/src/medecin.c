...
void ajouter_fiche(Fiche fi)
{
 ...
 FILE*f;
  f=fopen("/home/amine123/Downloads/project12/src/fiches.txt","a+");
  if(f!=NULL) 
  {
...
renderer, "text",TAILLE, NULL);
	...
	f = fopen("/home/amine123/Downloads/project12/src/fiches.txt", "r");
...
{	
	FILE*r ,*s;
        Fiche fi;
    	r=fopen("/home/amine123/Downloads/project12/src/fiches.txt","r+");
	    s=fopen("/home/amine123/Downloads/project12/src/fiches.tmp.txt","w+");
	if(r!=NULL) 
	{
	...
	r=fopen("/home/amine123/Downloads/project12/src/fiches.txt","w+");
	    s=fopen("/home/amine123/Downloads/project12/src/fiches.tmp.txt","r+");
	...
	fprintf(r,"%s %s %s %d %d %d %s %s %s %s %s %s  %s\n",f.identifiant,f.nom,f.prenom,f.jour,f.mois,f.annee,f.adresse,f.taille,f.poids,f.imc,f.groupe_sanguin,f.maladies,f.traitement);
			...
			remove("/home/amine123/Downloads/project12/src/fiches.tmp.txt");
...
{	
	FILE*r ,*s;
        Fiche fi;
    	r=fopen("/home/amine123/Downloads/project12/src/fiches.txt","a+");
	    s=fopen("/home/amine123/Downloads/project12/src/supprimer.txt","a+");
	if(r!=NULL) 
	{
			...
			fclose(r);
			fclose(s);
remove("/home/amine123/Downloads/project12/src/fiches.txt");
rename("/home/amine123/Downloads/project12/src/supprimer.txt","/home/amine123/Downloads/project12/src/fiches.txt");
}
}
