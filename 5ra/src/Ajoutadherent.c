...
{
	FILE *f;
	f=fopen("/home/josef/Projects/project1/src/Adherents.txt","a");
...
f=fopen("/home/josef/Projects/project1/src/Adherents.txt","r");
...
void Supprimer_Adherent(char *ID)
{
	...
	FILE *Ftemp;
	F=fopen("/home/josef/Projects/project1/src/Adherents.txt","a+");
	Ftemp=fopen ("/home/josef/Projects/project1/src/temp.txt","w+");
	if (F!=NULL){
...
remove ("/home/josef/Projects/project1/src/Adherents.txt");
rename ("/home/josef/Projects/project1/src/temp.txt","/home/josef/Projects/project1/src/Adherents.txt");
}
