...
{
	FILE *f;
	f=fopen("/home/josef/Projects/5ra/src/Evenements.txt","a");
...
f=fopen("/home/josef/Projects/5ra/src/Evenements.txt","r");
...
{
	FILE *f=fopen("/home/josef/Projects/5ra/src/Evenements.txt","r+");
	int existe;
	Evenement E;
...
void Supprimer_Ev(char *ID)
{
	...
	FILE *Ftemp;
	F=fopen("/home/josef/Projects/5ra/src/Evenements.txt","a+");
	Ftemp=fopen ("/home/josef/Projects/5ra/src/temp.txt","w+");
	if (F!=NULL){
...
remove ("/home/josef/Projects/5ra/src/Evenements.txt");
rename ("/home/josef/Projects/5ra/src/temp.txt","/home/josef/Projects/5ra/src/Evenements.txt");
}

int Nbr_Adherent()
{
	int n=0;	
	FILE *f=fopen("/home/josef/Projects/project1/src/Adherents.txt","r+");
	Adherent A;
...
{
	int n=0;	
	FILE *f=fopen("/home/josef/Projects/5ra/src/Coaches.txt","r+");
	Coach C;
...
{
	int n=0;	
	FILE *f=fopen("/home/josef/Projects/5ra/src/Medical.txt","r+");
	Medical M;
